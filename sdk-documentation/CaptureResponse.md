...
|**orderStatus** | **String** | Status of an order. the following status can be provided: - created: The order is created - pending_payment: Payment in progress - complete: Payment is completed - partial_complete: Payment is completed but all order amount is not payed - canceled: The order is canceled |  |
|**transactionList** | [**List&lt;Transaction&gt;**](Transaction.md) | List of transaction for the order |  |
